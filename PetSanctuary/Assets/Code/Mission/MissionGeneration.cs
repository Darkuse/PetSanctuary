...
public class MissionGeneration : MonoBehaviour
{
    ...
    private void PopulateWithMission(int animalIndex)
    {
        ...
        missionInstance.GetComponent<MissionLifeSpan>().SetMissionInfo(mission.missionName,mission.missionType, pickedAnimal.GetComponent<Animal>().animalInfo.difficultyWeight, mission.description,pickedAnimal);
    }
}
